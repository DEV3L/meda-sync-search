...
from app.meda_sync_search.services.os_env import os_environ

default_level = os_environ('DEFAULT_LOGGING_LEVEL', default=logging.INFO)
default_logging_format = os_environ('DEFAULT_LOGGING_FORMAT',
