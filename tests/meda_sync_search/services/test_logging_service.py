...
from app.meda_sync_search.services.logging_service import LoggingService, default_logging_format, default_level
...
@patch('app.meda_sync_search.services.logging_service.LoggingService._build_stream_handler')
@patch('app.meda_sync_search.services.logging_service.logging')
